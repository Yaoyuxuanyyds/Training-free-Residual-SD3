...
class QwenSampler:
    ...
    def sample(self, prompts, NFE, img_shape, cfg_scale):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--save_name", type=str, default="image_qwen")
    ...
    sampler = QwenSampler(
        ...
        residual_stop_grad=bool(args.residual_stop_grad),
    )
    ...
    if args.dataset is not None:
        ...
        for batch_indices, label in pbar:
            ...
            for bi, t in enumerate(missing_ids):
                ...
                pbar.set_description(f"Qwen Sampling [{t}/{num}]")
