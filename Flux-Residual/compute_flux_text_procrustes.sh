...
CUDA_VISIBLE_DEVICES=0 python compute_flux_text_procrustes.py \
  ...
  --output /inspire/hdd/project/chineseculture/public/yuxuan/Training-free-Residual-SD3/Flux-Residual/logs/procrustes_rotations/procrustes_rotations_coco1k_ln_t1-full-o2.pt \
  --col-center \
  --timestep-buckets 1 \