...
CUDA_VISIBLE_DEVICES=3 python compute_flux_text_procrustes.py \
  --dataset blip3o60k \
  ...
  --num-samples 5000 \
  --origin-layer 32 \
  --target-layer-start 33 \
  --output /inspire/hdd/project/chineseculture/public/yuxuan/Training-free-Residual-SD3/Flux-Residual/logs/procrustes_rotations/procrustes_rotations_coco5k_ln_t1-full-o32.pt \
  --col-center \
  --timestep-buckets 1 \
