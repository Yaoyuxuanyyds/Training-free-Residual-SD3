...
if __name__ == "__main__":
    ...
    parser.add_argument("--load_dir", type=str, default="/inspire/hdd/project/chineseculture/yaoyuxuan-CZXS25220085/p-yaoyuxuan/REPA-SD3-1/flux/FLUX.1-dev", help="replace it with your checkpoint")
